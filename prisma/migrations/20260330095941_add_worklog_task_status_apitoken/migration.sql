...
-- CreateEnum
CREATE TYPE "WorkLogSource" AS ENUM ('MANUAL', 'PREMIERE_CEP', 'API');
...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "role" TEXT NOT NULL DEFAULT 'ROLE_CLIENT',
...
CREATE TABLE "ApiToken" (
    ...
    "token" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "label" TEXT NOT NULL DEFAULT 'Premiere Plugin',
...
-- CreateIndex
CREATE UNIQUE INDEX "Client_driveFolderId_key" ON "Client"("driveFolderId");
